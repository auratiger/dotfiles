...
nkeymap("zs", ":lua require'telescope.builtin'.spell_suggest()<cr>") -- spelling suggestions

-- creates emoji glyphs in insert mode - these are totally unnecessary (except the last one)
ikeymap("<C-o>l", "<C-k>->")
ikeymap("<C-o>h", "<C-k><-")
ikeymap("<C-o>k", "<C-k>-!")
ikeymap("<C-o>j", "<C-k>-v")
