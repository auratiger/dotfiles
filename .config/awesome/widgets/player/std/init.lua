...
local prv_btn = controls.create("", 30, spotify.commands.cmdprev)
local tgl_btn = controls.create("", 30, spotify.commands.cmdtoggle)
local nxt_btn = controls.create("", 30, spotify.commands.cmdnext)
